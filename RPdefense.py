...
tf.flags.DEFINE_string(
    'checkpoint_path', './models_tf/adv_inception_v3', 'Path to checkpoint for inception network.')

tf.flags.DEFINE_string(
    'input_dir', './adv/PTNAA/res-v2/', 'Input directory with images.')

tf.flags.DEFINE_string(
    'output_file', '/adv/RP/PTNAA/inc-v3/10h/', 'Output file to save labels.')
