...
normalization_fn_map = {
    ...
    'mobilenet_v1': vgg_normalization,
    'NASNet-A_Mobile_224': vgg_normalization
}
...
inv_normalization_fn_map = {
    ...
    'mobilenet_v1': inv_vgg_normalization,
    'NASNet-A_Mobile_224': inv_vgg_normalization
}
...
image_size={
    ...
    'vgg_19': 224,
    'mobilenet_v1': 224,
    'NASNet-A_Mobile_224':224,
  }
base_path='./models_tf'

checkpoint_paths = {
    'inception_v1': base_path+'/inception_v1.ckpt',
    'inception_v2': base_path+'/inception_v2.ckpt',
    ...
    'resnet_v1_101': base_path+'/resnet_v1_101.ckpt',
    ...
    'mobilenet_v1': base_path+'/mobilenet_v1_1.0_224.ckpt',
    'NASNet-A_Mobile_224': base_path+'/model.ckpt'
  }
...
def load_image(image_path, image_size, batch_size, start_image_path):
    images = []
    filenames=[]
    labels=[]
    idx=0
    ...
    files1 = os.listdir(start_image_path)
